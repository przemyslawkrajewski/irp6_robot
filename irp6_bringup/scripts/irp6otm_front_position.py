...
if __name__ == '__main__':
	...
	irpos = IRPOS("irp6otm_front_position", "Irp6ot", 7,'irp6ot_manager')
	half_pi = math.pi/2
	...
	if sys.argv[1] == '1':
		...
		irpos.move_to_joint_position([0,0, -half_pi, 0, 0, 3*half_pi, -half_pi], 20.00)
		...
		irpos.move_to_joint_position([0,0, -half_pi, 0, half_pi, half_pi, -half_pi], 20.00)
